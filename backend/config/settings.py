...
SECRET_KEY = 'django-insecure-kw59_9us8t55$)1k@9xt=+&fzw_7-^4#4%^ak@x@oj@ybnta^w'
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "dsr_hirehub"),
        "USER": os.environ.get("POSTGRES_USER", "hirehub"),
